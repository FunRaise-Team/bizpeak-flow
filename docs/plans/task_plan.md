...
- [x] 獨立驗收（fresh-context 代理、線上 8 項）：首輪 7/8 — 抓到「催收信範本」線上被 Gemini 安全過濾擋成空回覆（本地不觸發、產製者自測沒抓到 → 驗證不自驗的實證）；修 safetySettings BLOCK_NONE＋空回覆備援（_fmt_fallback 工具結果原文照列）、線上原句 3 連測全過（69985b0）、代理複驗中
